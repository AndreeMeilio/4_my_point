                ...
                <tbody>
                    ...
                    while ($item = $data_siswa->fetch_assoc()) { ?>
                        <tr>
                            ...
                            <td><?php echo $item['tingkatan']. ' '. $item['nama_kelas'] ?></td>
                            <td>
                                <a class="btn btn-success" href="edit.php?nis=<?php echo $item['id_siswa']?>">Edit</a>
                                <form action="delete.php" method="POST">
                                    <button type="submit" class="btn btn-danger" name="id_siswa" value="<?php echo $item['id_siswa']?>">Delete</button>
                                </form>
