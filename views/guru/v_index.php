                    ...
                    <div class="col-md-15">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <span class="h5 m-0 font-weight-bold text-primary">Data Guru</span>
                                <?php if ($_SESSION["nama_hak_akses"] !== "siswa" && $_SESSION["nama_hak_akses"] !== "guru") { ?>
                                    ...
                                    <div class="d-none d-sm-inline">
                                        <a href="tambah.php" class="btn btn-primary" style="float:right;"><i class="fas fa-plus me-2"> Tambah Guru</i></a>
                                    </div>
                                <?php } ?>
                            </div>
                            <div class="card-body">
                                            ...
                                            foreach($result as $item) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        data-tempatlahir="<?php echo $item['tempat_lahir'] ?>" 
                                                        data-tanggallahir="<?php echo date('d F Y', strtotime($item['tanggal_lahir'])) ?>" data-jeniskelamin="<?php echo $item['jenis_kelamin'] ?>" 
                                                        data-agama="<?php echo $item['agama'] ?>" 
                                                        data-notelp="<?php echo $item['no_telepon'] ?>" 
                                                        data-alamat="<?php echo $item['alamat'] ?>">more</button>
                                                    </td>
                                                </tr>
                                        ...
                                        <tbody>
                                            ...
                                            foreach($result as $item) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <?php if ($_SESSION["nama_hak_akses"] !== "siswa" && $_SESSION["nama_hak_akses"] !== "guru") { ?>
                                                        <td class="col-3">
                                                            <a href="edit.php?id=<?php echo $item['id'] ?>" class="btn btn-success m-1 px-4">
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-12 font-weight-bold">NIK / NPWP</div>
                        <div class="col-12 mb-2 modal-nik"></div>
    ...
    <script>
        $(document).ready(() => {
            ...
            $('#detailModal').on('show.bs.modal', function(event) {
                ...
                modal.find('.modal-edit').prop('href', 'edit.php?id=' + id);
                modal.find('.modal-delete').val(id);
            })
        });
    </script>
</body>
